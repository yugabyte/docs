<h2 id="docker-create-cluster">1. Create a local cluster</h2>
...
<h2 id="docker-check-status-yb-docker-ctl">2. Check cluster status with yb-docker-ctl</h2>
...
<h2 id="docker-check-status-ui">3. Check cluster status with Admin UI</h2>
...
<h3 id="docker-overview-master-status">3.1 Overview and Master status</h3>
...
<h3 id="docker-tserver-status">3.2 TServer status</h3>
